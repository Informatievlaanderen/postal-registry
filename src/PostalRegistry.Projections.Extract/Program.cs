namespace PostalRegistry.Projections.Extract
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Starting Postal.Projections.Extract");
            ...
            try
            {
                var runner = container.GetService<PostalExtractRunner>();
                runner.CatchupPageSize = 1;
                runner.CatchupThreshold = 1;
        ...
        private static IServiceProvider ConfigureServices(IConfiguration configuration)
        {
            ...
            builder
                .RegisterType<PostalExtractRunner>()
                .SingleInstance();
