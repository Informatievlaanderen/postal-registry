namespace PostalRegistry.Api.Legacy.PostalInformation.Query
{
    ...
    public class PostalInformationListQuery : Query<PostalInformation, PostalInformationFilter>
    {
        ...
        public PostalInformationListQuery(LegacyContext context, SyndicationContext syndicationContext)
        {
            _context = context;
