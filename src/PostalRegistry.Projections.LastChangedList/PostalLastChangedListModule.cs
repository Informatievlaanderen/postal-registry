namespace PostalRegistry.Projections.LastChangedList
{
    ...
    public class PostalLastChangedListModule : LastChangedListModule
    {
        public PostalLastChangedListModule(
        ...
        {
            var logger = loggerFactory.CreateLogger<PostalLastChangedListModule>();
