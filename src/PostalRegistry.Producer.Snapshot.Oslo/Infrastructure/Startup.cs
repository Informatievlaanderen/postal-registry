namespace PostalRegistry.Producer.Snapshot.Oslo.Infrastructure
{
    using System;
    using System.Linq;
    ...
    public class Startup
    {
            ...
            app
                ...
                .UseDefaultForApi(new StartupUseOptions
                {
                    ...
                    Api =
                    {
                        ...
                        Info = groupName => $"Basisregisters Vlaanderen - Postal Registry API {groupName}",
                        CSharpClientOptions =
                        {
                            ClassName = "PostalRegistryProducer",
        ...
        private static string GetApiLeadingText(ApiVersionDescription description)
            => $"Momenteel leest u de documentatie voor versie {description.ApiVersion} van de Basisregisters Vlaanderen Postal Registry Producer Snapshot Oslo API{string.Format(description.IsDeprecated ? ", **deze API versie is niet meer ondersteund * *." : ".")}";
    }
}
