namespace PostalRegistry.Api.Oslo.PostalInformation.V2
{
    using System;
    ...
    using PostalRegistry.Api.Oslo.Infrastructure;
    using PostalRegistry.Api.Oslo.Infrastructure.Options;
    using PostalRegistry.Api.Oslo.Nuts;
    ...
    public class PostalInformationOsloController : ApiController
    {
            ...
            IConfiguration configuration)
        {
            ...
            using (var xmlWriter = XmlWriter.Create(sw, new XmlWriterSettings { Async = true, Indent = true, Encoding = sw.Encoding }))
            {
                ...
                var syndicationConfiguration = configuration.GetSection("V2").GetSection("Syndication");
